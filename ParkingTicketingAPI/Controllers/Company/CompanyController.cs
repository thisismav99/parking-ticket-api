...
namespace ParkingTicketingAPI.Controllers.Company
{
    ...
    public class CompanyController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] AddCompanyDTO addCompanyDTO,
            CancellationToken cancellationToken)
        {
            var command = new AddCompanyCommand(addCompanyDTO.Name,
                addCompanyDTO.Description,
                addCompanyDTO.CreatedBy,
                addCompanyDTO.IsActive);
            ...
            var linkGenerator = new Dictionary<string, string?>()
            {
                ...
                { "List",  _linkGenerator.GenerateLink(HttpContext, "Get", "Company", null) },
                { "Self", _linkGenerator.GenerateLink(HttpContext, "Post", "Company", null) }
            };
